...
public class BasePage extends DriverFactory {
	...
	public String retornaTextoAtributoElemento(String texto) {
		...
		return el.getAttribute("content-desc");// Só é possível ler os atributos que contém o texto esperado,
	...
	public void arrastaSeekBar(String content_desc, double pos) {
		...
		// xinicial = ponto x inicial do elemento = delta (delta � o ponto x + início do
